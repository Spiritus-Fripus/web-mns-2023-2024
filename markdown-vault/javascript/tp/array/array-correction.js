...
studentsWithAverage.sort((a, b) => b.average - a.average)
const jeanIndex = studentsWithAverage.findIndex((student) => student.firstName === "Jean");
...
const maleJsAverage = males.reduce((sum, male) => sum += male.js.mark, 0) / males.length

const femaleJsAverage = females.reduce((sum, female) => sum += female.js.mark, 0) / females.length
